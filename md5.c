 ...
 */
void MD5Init(struct SM_MD5Context *ctx)
{
 ...
 * of bytes.
 */
void MD5Update(struct SM_MD5Context *ctx, unsigned char const *buf, unsigned len)
{
    md5_uint32 t;
 ...
 */
void MD5Final(unsigned char digest[16], struct SM_MD5Context *ctx)
{
    unsigned count;
    unsigned char *p;
